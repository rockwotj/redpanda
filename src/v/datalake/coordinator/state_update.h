...
inline constexpr std::string_view format_as(update_key u) {
    switch (u) {
...
template<>
struct fmt::formatter<datalake::coordinator::update_key>
  : fmt::formatter<std::string_view> {
    auto format(
      datalake::coordinator::update_key e, fmt::format_context& ctx) const {
