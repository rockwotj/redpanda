...
public:
    ...
    ///
    /// Small file optimization: If total data < part_size when complete() is
    /// called, automatically uses regular put_object() for efficiency.
    ///
    ...
    ///        - Recommendation: 64 MiB for good balance
