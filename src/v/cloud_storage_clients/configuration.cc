...
fmt::iterator s3_configuration::format_to(fmt::iterator it) const {
    return fmt::format_to(
      it,
      "{{access_key:{},region:{},service:{},secret_key:****"
      ",url_style:{},access_point_uri:{},server_addr:{},max_idle_time:{}}}",
...
fmt::iterator abs_configuration::format_to(fmt::iterator it) const {
    return fmt::format_to(
      it,
      "{{storage_account_name: {}, shared_key:{}"
      ", access_point_uri:{}, server_addr:{}"
      ", max_idle_time:{}, is_hns_enabled:{}}}",
      storage_account_name(),
...
fmt::iterator
abs_self_configuration_result::format_to(fmt::iterator it) const {
    return fmt::format_to(it, "{{is_hns_enabled: {}}}", is_hns_enabled);
}

fmt::iterator
s3_self_configuration_result::format_to(fmt::iterator it) const {
...
operator<<(std::ostream& o, const client_self_configuration_output& r) {
    ss::visit(
      ...
      [&o](const s3_self_configuration_result& self_cfg) {
          fmt::print(o, "{{s3_self_configuration_result: {}}}", self_cfg);
      },
      [&o](const abs_self_configuration_result& self_cfg) {
          fmt::print(o, "{{abs_self_configuration_result: {}}}", self_cfg);
      });
...
std::ostream& operator<<(std::ostream& o, const client_configuration& c) {
    ss::visit(
      ...
      [&o](const s3_configuration& cfg) {
          fmt::print(o, "{{s3_configuration: {}}}", cfg);
      },
      [&o](const abs_configuration& cfg) {
          fmt::print(o, "{{abs_configuration: {}}}", cfg);
      });
