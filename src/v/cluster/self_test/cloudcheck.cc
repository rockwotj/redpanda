...
cloudcheck::verify_multipart_upload(
  ...
  iobuf payload) {
    ...
    try {
        ...
        // Initiate multipart upload with 5 MiB part size using the clean API
        ...
        co_await upload->put(payload.share());
