...
std::string_view format_as(candidate_creation_error err) {
    switch (err) {
    case candidate_creation_error::no_segments_collected:
        return "candidate creation error: no segments collected";
    case candidate_creation_error::begin_offset_seek_error:
        return "candidate creation error: failed to seek begin offset";
    case candidate_creation_error::end_offset_seek_error:
        return "candidate creation error: failed to seek end offset";
    case candidate_creation_error::offset_inside_batch:
        return "candidate creation error: offset inside batch";
    case candidate_creation_error::upload_size_unchanged:
        return "candidate creation error: size of candidate unchanged";
    case candidate_creation_error::cannot_replace_manifest_entry:
        return "candidate creation error: candidate cannot replace manifest entry";
    case candidate_creation_error::no_segment_for_begin_offset:
        return "candidate creation error: no segment for begin offset";
    case candidate_creation_error::missing_ntp_config:
        return "candidate creation error: missing config for NTP";
    case candidate_creation_error::failed_to_get_file_range:
        return "candidate creation error: failed to get file range for candidate";
    case candidate_creation_error::zero_content_length:
        return "candidate creation error: candidate has no content";
    case candidate_creation_error::concurrency_error:
        return "candidate creation error: collected segments are modified concurrently";
    }
}
